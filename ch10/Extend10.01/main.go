...
func main() {
	...
	if err == nil {
		// 15: 15 代表用 24 小時制表示"時", 如果用 3 表示用 12 小時制
		// 04: 04 代表用 2 位數表示"分", 如果用 4 代表 1 位數表示"分"
		// 05: 05 代表用 2 位數表示"秒", 如果用 5 代表 1 位數表示"秒"
		// 01: 01 代表用 2 位數表示"月", 如果用 1 代表 1 位數表示"月"
		// 02: 02 代表用 2 位數表示"日", 如果用 2 代表 1 位數表示"日"
		// 2006:  4 位數表示"年"
